...
// Function to hide header and footer elements, and other unwanted elements
function hideHeaderAndFooter() {
    const style = document.createElement('style');
    style.innerHTML = `
        #headerNav,
        footer,
        header.header, /* Added to hide the header */
        div.DownloadArea /* Added to hide the download area */
...
document.addEventListener('DOMContentLoaded', function() {
    hideHeaderAndFooter(); // This function now includes the new hiding logic
